...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products1_ibfk_1` FOREIGN KEY (`seller_id`) REFERENCES `users` (`user_id`),
  CONSTRAINT `products1_ibfk_2` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'jjjj',NULL,NULL,NULL,NULL,NULL,'pending',0),(2,'kkk',NULL,NULL,NULL,NULL,NULL,'pending',0),(3,'lhd',NULL,NULL,NULL,NULL,NULL,'pending',0),(4,'jhj',NULL,NULL,NULL,NULL,NULL,'pending',0),(5,'kgd',NULL,NULL,NULL,NULL,NULL,'pending',0),(6,'ddd',NULL,NULL,NULL,NULL,NULL,'pending',0);
...
-- Dump completed on 2024-05-17 14:27:48
